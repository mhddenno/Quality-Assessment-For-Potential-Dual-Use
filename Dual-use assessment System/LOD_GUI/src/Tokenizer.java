...
public class Tokenizer {
	...
	/**
     * public Constructor that which will take the words form trivial_words.DATA and load them to be discarded from the sentence
     * @param non
     * @return non
     */
	...
	/**
     * public method which will return an arraylist with the important words from the question
     * @param question
     * @return tokens
     */
	...
	/**
     * public method which will apply a permutation on the question words to be used in querying
     * @param tokens
     * @return combination
     */
